// institutionVersion/institutionrecInteractive/institutionrecInteractive.js
...
Page({
  ...
  data: {
    ...
    nums:0,
    chooseCoupons:[
      {type:'stay',name:'我的客户',num:'3'},
      {type:'has',name:'申请记录',num:'1'},
      {type:'overdue',name:'我的关注',num:'0'},
      {type:'overdue',name:'谁关注了我',num:'0'},
      {type:'stay',name:'留言记录',num:'3'},
      {type:'has',name:'我的动态',num:'1'},
      {type:'overdue',name:'好友动态',num:'0'},
      {type:'overdue',name:'附近动态',num:'0'}
    ], // 状态选择

...
module.exports = {
    ...
    buyNow: function(t, d, i) {
        ...
        if (r > 0 && !s) return console.log(s,'kk2'), console.log(r,'kk3'), void o.toast(d, "请选择规格");
        if (n && n.fields.length > 0) {
            if (!e.verify(d, n)) return;
            console.log(n.f_data,'kk4'), a.post("order/create/diyform", {
                id: d.data.id,
    ...
    getCart: function(t, d) {
        ...
        if (s > 0 && !i) o.toast(d, "请选择规格"); else if (d.data.quickbuy) {
            ...
            a.post("order/create/diyform", {
                ...
                console.log(d.data,'kk8'), a.post("member/cart/add", {
                    id: d.data.id,
                    total: d.data.total,
                    optionid: i,
                    diyformdata: r.f_data
    ...
    selectpicker: function(t, o, e, d) {
        ...
        a.get("goods/get_picker", {
            ...
            if ("goodsdetail" == e) if (o.setData({
                ...
                specsData: [],
                specs: []
            }), console.log(o.data.specsData,'kk10'), 0 != a.goods.minbuy && o.data.total < a.goods.minbuy) r = a.goods.minbuy; else var r = 1;
            a.diyform && o.setData({
                diyform: {
